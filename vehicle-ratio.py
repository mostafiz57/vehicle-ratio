...
def rgb_to_bgr(file_path,parent_path,img_name):
    ...
    #with open("D:/MS/Traffic_Monitoring/app/Output.txt", "w") as text_file:
       # text_file.write("Ratio : %s ratio" % (ratio))
    #print(ratio)
...
def writter_text(file_path,ratio,img_name):
    ...
    d.text((10,10), "Ration :%s "% ratio, fill=(255,255,0),font=font)
